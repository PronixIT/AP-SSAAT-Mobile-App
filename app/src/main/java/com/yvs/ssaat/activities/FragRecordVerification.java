...
public class FragRecordVerification extends Fragment{

    public FragRecordVerification() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.view_recordverify, container, false);
